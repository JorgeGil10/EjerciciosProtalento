package dbc.main.protalento.jdbc.implementations;
...
import dbc.main.protalento.DataBaseConnector.ConnectionMariaDB;
import dbc.main.protalento.jdbc.DAO.DAO;

public class WebTextSearchImp<WebTextSearch> implements DAO<WebTextSearch, Integer>, ConnectionMariaDB {
	...
	public boolean insert(WebTextSearch element) { 
		...
		try {
			...
			preparedStatementInsert.setString(4, dbc.main.protalento.entities.LocalDateUtillities.getLocalDateTimeString(dateTime, dbc.main.protalento.entities.LocalDateUtillities.SQL_DATETIME_PATTERN));
